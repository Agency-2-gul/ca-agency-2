...
const FooterPopup = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      <motion.div
        className="fixed bottom-[64px] bg-gradient-to-t from-[#E64D20] to-[#F67B39] left-0 w-full max-h-[calc(100vh-64px)] h-auto shadow-xl p-6 rounded-t-2xl transition-all z-20 overflow-y-auto"
        initial={{ y: '100%' }}
