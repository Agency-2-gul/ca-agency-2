...
const Profile = () => {
  ...
  const handleDeleteAccount = async () => {
    if (confirmationText !== "Jeg vil slette min konto") {
      setError("Teksten stemmer ikke. Skriv nøyaktig: 'Jeg vil slette min konto'");
      return;
    }
    ...
    try {
      ...
      setError("Kunne ikke slette brukeren. Passordet kan være feil, eller du må logge inn på nytt.");
    } finally {
        ...
        {!showDeleteConfirm ? (
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-600 mb-2">
              Skriv inn: <strong>"Jeg vil slette min konto"</strong> for å bekrefte.
            </p>
            <input
              type="text"
            ...
            <p className="text-sm text-gray-600 mt-2">Skriv inn passordet ditt:</p>
            <input
              type="password"
              value={password}
            ...
            <button
              ...
              disabled={
                confirmationText !== "Jeg vil slette min konto" || !password || isReauthenticating
              }
